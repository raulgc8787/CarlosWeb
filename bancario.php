...
<head>
<title><?php echo METAS_BANCARIO_TIT;?></title>
<meta name="keywords" content="<?php echo METAS_KW;?>" />
<meta name="description" content="<?php echo METAS_BANCARIO_DESC;?>" />
...
<body class="srvPage bancario <?php echo IDIOMA;?> flex">
...
<div class="outtercbp">	
	<ul id="cbp-bislideshow" class="cbp-bislideshow">
		<li>
			<img src="images/branding/<?php echo $prefijo;?>15.jpg">
				<div class="container">
					<em><h1><?php echo BANCARIO_H1; ?></h1></em>
				</div>
		</li>
	</ul>
</div>
...
<div class="block1">
	<div class="intro">   
			<div class="columnsCSS">
				<img src="images/icons/serveis-03.svg" alt="<?php echo METAS_BANCARI_ALT;?>">
				<h2><?php echo BANCARIO_H2; ?></h2>
				<div class="text"><? echo BANCARIO_INTRO ; ?></div>
