...
$max_orden = db_query($link,"SELECT MAX(orden) AS max FROM ".$tabla." WHERE id_elem=".$id);
...
if (!$chunks || $chunk == $chunks - 1) {
	...
	$inserta_foto = db_query($link,"INSERT INTO `".$tabla."`(id_elem,foto,orden) VALUES('".$id."','".$fileName."','".$nuevo_orden."')");
}
