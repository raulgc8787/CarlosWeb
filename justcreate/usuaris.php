...
$sufijo_plural = "usuaris";
$sufijo_singular = "usuari";
...
/*
$ac = db_query($link,"SELECT * FROM ".$table." t, ".$table."_content tc WHERE t.id=tc.id AND tc.idioma='".IDIOMA."' ");
$cuantos = mysqli_num_rows($ac);
*/
