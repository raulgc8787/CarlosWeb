...
<head>
<title><?php echo METAS_HERENCIA_TIT;?></title>
<meta name="keywords" content="<?php echo METAS_KW;?>" />
<meta name="description" content="<?php echo METAS_HERENCIA_DESC;?>" />
...
<body class="srvPage herencia <?php echo IDIOMA;?> flex">
...
<div class="outtercbp">	
	<ul id="cbp-bislideshow" class="cbp-bislideshow">
		<li>
			<img src="images/branding/<?php echo $prefijo;?>02.jpg" alt="<?php echo METAS_HERENCIA_ALT; ?>">
				<div class="container">
					<em><h1><?php echo HERENCIA_H1; ?></h1></em>
				</div>
		</li>
	</ul>
</div>
...
<div class="block1">
	<div class="intro">   
			<div class="columnsCSS">
				<img src="images/icons/serveis-01.svg" alt="">
				<h2><?php echo HERENCIA_H2; ?></h2>
				<div class="text"><? echo HERENCIA_INTRO ; ?></div>
